...
!function($){
	$.fn.scrollBanner = function(obj){
		...
		$.each(obj.images,function(index,item){
			$(".scrollBanner-banner").append("<div class='scrollBanner-bannerInner'><a href='"+item.href+"'target='_black'><i style='display: inline-block;background-image: url(" + item.src + ");width: 100%;height: 500px;background-size: cover;background-position: center;'></i></a></div>");
		});
		$(".scrollBanner-banner").append("<div class='scrollBanner-bannerInner'><a href='"+obj.images[0].href+"' target='_black'><i style='display: inline-block;background-image: url(" + obj.images[0].src + ");width: 100%;height: 500px;background-size: cover;background-position: center;'></i></a></div>");
...
//		});
		...
		setInterval(function(){
			...
			$(".scrollBanner-icon").css({"background-color":obj.iconColor,"height": "10px"});
			$(".scrollBanner-icon:eq("+count+")").css({"background-color":obj.iconHoverColor,"height": "10px"});
			
			if(count>=obj.images.length)
			$(".scrollBanner-icon:eq("+0+")").css({"background-color":obj.iconHoverColor,"height": "10px"});
		...
		$(".scrollBanner-icon").mouseover(function(){
			$(".scrollBanner-icon").css({"background-color":"white","height": "10px"});
			// ↓ 由span触发mouseover事件，则this指向这个span。
			// ↓ 但是，这this是JS对象，必须使用$封装成JQuery对象。
			$(this).css({"background-color":obj.iconHoverColor,"height": "10px"});
